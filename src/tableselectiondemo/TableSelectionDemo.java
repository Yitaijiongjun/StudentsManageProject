...
public class TableSelectionDemo extends JPanel 
    ...
    public TableSelectionDemo() {
        ...
        table.setFillsViewportHeight(true); // 设置默认使用表格填充窗口
        table.getSelectionModel().addListSelectionListener(new RowListener()); // 获取选择模型, 添加行监听器
